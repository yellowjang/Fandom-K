      ...
      {[...Array(4)].map((_, index) => (
        <div key={index} className={styles['donation-element']}>
          <div className={styles['image-box']}>
            ...
            <div className={`${styles['donation-img']} ${styles['skeleton']}`} />
            <button className={styles['skeleton-button']}></button>
          </div>
          <div className={styles['donation-contents']}>
            <div className={styles['title-wrapper']}>
              <div className={`${styles['subtitle']} ${styles['skeleton-text']} ${styles['short']}`} />
              <div className={`${styles['title']} ${styles['skeleton-text']} ${styles['long']}`} />
            </div>
            <div className={styles['current-credit-box']}>
              ...
              <div className={`${styles['progress-bar']} ${styles['skeleton-progress-bar']}`} />
            </div>
          </div>
        </div>
      ))}
